                      ...
                      >
                        <div className="grid grid-cols-2 gap-2 text-[16px] sm:grid-cols-3">
                          ...
                          <div className={`flex w-full flex-col gap-2 rounded-lg border px-2 py-2 shadow-sm ${index === 0
                            ...
                            <p className={`text-[10px] uppercase tracking-[0.12em] ${index === 0 ? 'text-black/75' : 'text-slate-400'}`}>
                              Fotos
                            </p>
                            <div className="flex items-center justify-center gap-2">
                              {item.photo_front_url && (
                                <button
                                  ...
                                  className="relative h-16 w-16 overflow-hidden rounded-md border border-slate-600 bg-slate-950/50 p-0 transition hover:scale-[1.02] hover:border-[#f1b80c]"
