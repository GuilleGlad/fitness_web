          ...
          <div className="hidden overflow-x-auto lg:block">
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-slate-800/50">
                {loading ? (
                  <tr><td colSpan="8" className="py-12 text-center text-slate-400">Cargando pagos</td></tr>
                ) : payments.length === 0 ? (
                  <tr><td colSpan="8" className="py-12 text-center text-slate-400">No hay pagos aún.</td></tr>
                ) : (
                  payments.map((r) => (
                    <PaymentRow
                      key={r.id}
                      ...
                      setPaymentPreviewImage={setPaymentPreviewImage}
                      yesNo={yesNo}
