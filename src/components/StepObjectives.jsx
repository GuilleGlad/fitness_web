    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        <button
          ...
          className={`w-full p-4 rounded-xl border text-left transition-all ${formData.goal === 'perder_grasa'
        ...
        <button
          ...
          className={`w-full p-4 rounded-xl border text-left transition-all ${formData.goal === 'aumentar_masa'
              ? 'border-[#f1b80c] bg-[#f1b80c]/10 text-[#f1b80c]'
              : 'border-slate-700 bg-slate-800 text-slate-300 hover:border-slate-600'
            }`}
        >
